        ...
        , q = l.BufferedBlockAlgorithm = t.extend({
            ...
            mF8x: function (a) {
                var c = this.i5n
                    ...
                    , k = this.blockSize
                    , b = j / (4 * k)
                    , b = a ? u.ceil(b) : u.max((b | 0) - this.Vm7f, 0);
                a = b * k;
                j = u.min(4 * a, j);
                if (a) {
                    for (var q = 0; q < a; q += k)
    ...
    var p = CryptoJS
        ...
        , v = d.Cipher = t.extend({
            ...
            createEncryptor: function (e, a) {
                return this.create(this.HP5U, e, a)
            },
            createDecryptor: function (e, a) {
                return this.create(this.bqQ0x, e, a)
            },
            init: function (e, a, b) {
...
(function () {
    ...
    var H = [0, 1, 2, 4, 8, 16, 32, 64, 128, 27, 54]
        , d = d.AES = p.extend({
            mo8g: function () {
                for (var a = this.J5O, c = a.words, d = a.sigBytes / 4, a = 4 * ((this.bbG8y = d + 6) + 1), e = this.bqM0x = [], j = 0; j < a; j++)
                    if (j < d)
                        e[j] = c[j];
                    else {
                        var k = e[j - 1];
            ...
            encryptBlock: function (a, b) {
                this.De1x(a, b, this.bqM0x, t, r, w, v, l)
            },
            decryptBlock: function (a, c) {
                var d = a[c + 1];
                a[c + 1] = a[c + 3];
                a[c + 3] = d;
                this.De1x(a, c, this.bqJ0x, b, x, q, n, s);
                d = a[c + 1];
                a[c + 1] = a[c + 3];
                a[c + 3] = d
            },
            De1x: function (a, b, c, d, e, j, l, f) {
                for (var m = this.bbG8y, g = a[b] ^ c[0], h = a[b + 1] ^ c[1], k = a[b + 2] ^ c[2], n = a[b + 3] ^ c[3], p = 4, r = 1; r < m; r++)
...
function getData(i5n) {
    e = '010001'
    f = ''
    g = '0CoJUm6Qyw8W8jud'
    var bYy0x = asrsea(JSON.stringify(i5n), e, f, g);
    return bYy0x
}
// console.log(bYy0x)